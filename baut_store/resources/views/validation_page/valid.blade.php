...
<head>
    ...
    <style>
        body {
            background: linear-gradient(to bottom right, #3f70b7, #1f2937);
        }
    </style>
</head>
        ...
        document.getElementById('toggle-text').addEventListener('click', (event) => {
            if (event.target.id === 'toggle-button') {
                ...
                if (isLoginVisible) {
                    ...
                    toggleText.innerHTML = 'Sudah punya akun? <button id="toggle-button" class="text-blue-500 hover:underline">Login</button>';
                } else {
                    // Tampilkan Login
                    ...
                    toggleText.innerHTML = 'Belum punya akun? <button id="toggle-button" class="text-blue-500 hover:underline">Daftar</button>';
                }
            }
        });
    </script>
